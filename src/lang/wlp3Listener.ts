...
import { SingleArrElemContext } from "./wlp3Parser";
import { MultiArrElemsContext } from "./wlp3Parser";
...
import { ArrInitElemsContext } from "./wlp3Parser";
import { ArrInitEmptyContext } from "./wlp3Parser";
...
import { ForStatementContext } from "./wlp3Parser";
...
import { DclArrAssignmentContext } from "./wlp3Parser";
import { ArrIndexContext } from "./wlp3Parser";
...
import { ArrinitContext } from "./wlp3Parser";
import { ArrinitelemsContext } from "./wlp3Parser";
...
export interface wlp3Listener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by the `SingleArrElem`
	 * labeled alternative in `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 */
	enterSingleArrElem?: (ctx: SingleArrElemContext) => void;
	/**
	 * Exit a parse tree produced by the `SingleArrElem`
	 * labeled alternative in `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 */
	exitSingleArrElem?: (ctx: SingleArrElemContext) => void;

	/**
	 * Enter a parse tree produced by the `MultiArrElems`
	 * labeled alternative in `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 */
	enterMultiArrElems?: (ctx: MultiArrElemsContext) => void;
	/**
	 * Exit a parse tree produced by the `MultiArrElems`
	 * labeled alternative in `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 */
	exitMultiArrElems?: (ctx: MultiArrElemsContext) => void;
	...
	/**
	 * Enter a parse tree produced by the `ArrInitElems`
	 * labeled alternative in `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 */
	enterArrInitElems?: (ctx: ArrInitElemsContext) => void;
	/**
	 * Exit a parse tree produced by the `ArrInitElems`
	 * labeled alternative in `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 */
	exitArrInitElems?: (ctx: ArrInitElemsContext) => void;

	/**
	 * Enter a parse tree produced by the `ArrInitEmpty`
	 * labeled alternative in `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 */
	enterArrInitEmpty?: (ctx: ArrInitEmptyContext) => void;
	/**
	 * Exit a parse tree produced by the `ArrInitEmpty`
	 * labeled alternative in `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 */
	exitArrInitEmpty?: (ctx: ArrInitEmptyContext) => void;
	...
	/**
	 * Enter a parse tree produced by the `DclArrAssignment`
	 * labeled alternative in `wlp3Parser.expr`.
	 * @param ctx the parse tree
	 */
	enterDclArrAssignment?: (ctx: DclArrAssignmentContext) => void;
	/**
	 * Exit a parse tree produced by the `DclArrAssignment`
	 * labeled alternative in `wlp3Parser.expr`.
	 * @param ctx the parse tree
	 */
	exitDclArrAssignment?: (ctx: DclArrAssignmentContext) => void;

	/**
	 * Enter a parse tree produced by the `ArrIndex`
	 * labeled alternative in `wlp3Parser.expr`.
	 * @param ctx the parse tree
	 */
	enterArrIndex?: (ctx: ArrIndexContext) => void;
	/**
	 * Exit a parse tree produced by the `ArrIndex`
	 * labeled alternative in `wlp3Parser.expr`.
	 * @param ctx the parse tree
	 */
	exitArrIndex?: (ctx: ArrIndexContext) => void;
	...
	/**
	 * Enter a parse tree produced by `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 */
	enterArrinit?: (ctx: ArrinitContext) => void;
	/**
	 * Exit a parse tree produced by `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 */
	exitArrinit?: (ctx: ArrinitContext) => void;

	/**
	 * Enter a parse tree produced by `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 */
	enterArrinitelems?: (ctx: ArrinitelemsContext) => void;
	/**
	 * Exit a parse tree produced by `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 */
	exitArrinitelems?: (ctx: ArrinitelemsContext) => void;
