...
export class wlp3Parser extends Parser {
	...
	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		...
		"'*'", "'&'", "'if'", "'else'", "'while'", "'for'", "'printf'", "'return'", 
		"'free'", "'break'", "'continue'", "'+'", "'-'", "'/'", "'%'", "'=='", 
		"'>'", "'<'", "'<='", "'>='", "'!='", "'&&'", "'||'", "'!'",
	];
	...
	public binaryoperator(): BinaryoperatorContext {
		...
		try {
			...
			if (!(((((_la - 16)) & ~0x1F) === 0 && ((1 << (_la - 16)) & ((1 << (wlp3Parser.T__15 - 16)) | (1 << (wlp3Parser.T__26 - 16)) | (1 << (wlp3Parser.T__27 - 16)) | (1 << (wlp3Parser.T__28 - 16)) | (1 << (wlp3Parser.T__29 - 16)) | (1 << (wlp3Parser.T__30 - 16)) | (1 << (wlp3Parser.T__31 - 16)) | (1 << (wlp3Parser.T__32 - 16)) | (1 << (wlp3Parser.T__33 - 16)) | (1 << (wlp3Parser.T__34 - 16)) | (1 << (wlp3Parser.T__35 - 16)))) !== 0))) {
