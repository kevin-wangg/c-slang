            ...
            this.enterOuterAlt(_localctx, 1)
            {
                ...
                if (
                    !(
                        ((_la - 15) & ~0x1f) === 0 &&
                        ((1 << (_la - 15)) &
                            ((1 << (wlp3Parser.T__14 - 15)) |
                                (1 << (wlp3Parser.T__28 - 15)) |
                                (1 << (wlp3Parser.T__29 - 15)) |
                                (1 << (wlp3Parser.T__30 - 15)) |
                                (1 << (wlp3Parser.T__31 - 15)) |
                                (1 << (wlp3Parser.T__32 - 15)) |
                                (1 << (wlp3Parser.T__33 - 15)) |
                                (1 << (wlp3Parser.T__34 - 15)) |
                                (1 << (wlp3Parser.T__35 - 15)) |
                                (1 << (wlp3Parser.T__36 - 15)) |
                                (1 << (wlp3Parser.T__37 - 15)))) !==
                            0
                    )
                ) {
...
export class ArrinitContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return wlp3Parser.RULE_arrinit
    }
...
export class ArrinitelemsContext extends ParserRuleContext {
    ...
    // @Override
    public get ruleIndex(): number {
        return wlp3Parser.RULE_arrinitelems
    }
