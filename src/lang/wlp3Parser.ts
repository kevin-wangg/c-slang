            ...
            this.enterOuterAlt(_localctx, 1)
            {
                ...
                if (
                    !(
                        ((_la - 18) & ~0x1f) === 0 &&
                        ((1 << (_la - 18)) &
                            ((1 << (wlp3Parser.T__17 - 18)) |
                                (1 << (wlp3Parser.T__28 - 18)) |
                                (1 << (wlp3Parser.T__29 - 18)) |
                                (1 << (wlp3Parser.T__30 - 18)) |
                                (1 << (wlp3Parser.T__31 - 18)) |
                                (1 << (wlp3Parser.T__32 - 18)) |
                                (1 << (wlp3Parser.T__33 - 18)) |
                                (1 << (wlp3Parser.T__34 - 18)) |
                                (1 << (wlp3Parser.T__35 - 18)) |
                                (1 << (wlp3Parser.T__36 - 18)) |
                                (1 << (wlp3Parser.T__37 - 18)))) !==
                            0
                    )
                ) {
