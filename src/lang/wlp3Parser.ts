...
export class wlp3Parser extends Parser {
	...
	private static readonly _LITERAL_NAMES: Array<string | undefined> = [
		...
		"'malloc'", "'['", "']'", "'if'", "'else'", "'while'", "'for'", "'printf'", 
	...
	public expr(_p?: number): ExprContext {
		...
		try {
			...
			case 5:
				...
				this.state = 110;
				(_localctx as StarExprContext)._first = this.expr(12);
				}
				break;
			...
			case 7:
				...
				this.state = 114;
				(_localctx as UnopExprContext)._first = this.expr(10);
				}
				break;
			...
			case 11:
				...
				this.match(wlp3Parser.T__1);
				this.state = 129;
				(_localctx as AssignmentContext)._val = this.expr(4);
				}
				break;
			...
			case 12:
				...
				this.match(wlp3Parser.T__1);
				this.state = 133;
				(_localctx as DclAssignmentContext)._val = this.expr(3);
				}
				break;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.state = 153;
						(_localctx as BinopExprContext)._second = this.expr(7);
						}
						break;
					...
					case 2:
						...
						this.state = 157;
						(_localctx as BinlogExprContext)._second = this.expr(6);
						}
						break;
					}
					}
	...
	public binaryoperator(): BinaryoperatorContext {
		...
		try {
			...
			if (!(((((_la - 15)) & ~0x1F) === 0 && ((1 << (_la - 15)) & ((1 << (wlp3Parser.T__14 - 15)) | (1 << (wlp3Parser.T__28 - 15)) | (1 << (wlp3Parser.T__29 - 15)) | (1 << (wlp3Parser.T__30 - 15)) | (1 << (wlp3Parser.T__31 - 15)) | (1 << (wlp3Parser.T__32 - 15)) | (1 << (wlp3Parser.T__33 - 15)) | (1 << (wlp3Parser.T__34 - 15)) | (1 << (wlp3Parser.T__35 - 15)) | (1 << (wlp3Parser.T__36 - 15)) | (1 << (wlp3Parser.T__37 - 15)))) !== 0))) {
	...
	public static readonly _serializedATN: string =
		...
		"\x04\x02\x11\x11\x1F(\x03\x02)*\x02\u011D\x028\x03\x02\x02\x02\x04:\x03" +
		...
		"\x02ed\x03\x02\x02\x02f\x13\x03\x02\x02\x02gh\b\v\x01\x02h\x98\x07-\x02" +
		"\x02i\x98\x07.\x02\x02j\x98\x07/\x02\x02kl\x07\x07\x02\x02lm\x05\x14\v" +
		"\x02mn\x07\b\x02\x02n\x98\x03\x02\x02\x02op\x07\x11\x02\x02p\x98\x05\x14" +
		"\v\x0Eqr\x07\x12\x02\x02r\x98\x05(\x15\x02st\x05$\x13\x02tu\x05\x14\v" +
		"\fu\x98\x03\x02\x02\x02v\x98\x070\x02\x02wx\x070\x02\x02xy\x07\x07\x02" +
		"\x02yz\x05\x18\r\x02z{\x07\b\x02\x02{\x98\x03\x02\x02\x02|}\x07\x13\x02" +
		"\x02}~\x07\x07\x02\x02~\x7F\x05\x14\v\x02\x7F\x80\x07\b\x02\x02\x80\x98" +
		"\x03\x02\x02\x02\x81\x82\x05(\x15\x02\x82\x83\x07\x04\x02\x02\x83\x84" +
		"\x05\x14\v\x06\x84\x98\x03\x02\x02\x02\x85\x86\x05\x10\t\x02\x86\x87\x07" +
		"\x04\x02\x02\x87\x88\x05\x14\v\x05\x88\x98\x03\x02\x02\x02\x89\x8A\x05" +
		"\x12\n\x02\x8A\x8B\x070\x02\x02\x8B\x8C\x07\x14\x02\x02\x8C\x8D\x07\x15" +
		"\x02\x02\x8D\x8E\x07\x04\x02\x02\x8E\x8F\x07\t\x02\x02\x8F\x90\x05\x1C" +
		"\v\x02\xCF\xD0\x07\x03\x02\x02\xD0\xDF\x03\x02\x02\x02\xD1\xD2\x07\x1C" +
		"\x02\x02\xD2\xD3\x07\x07\x02\x02\xD3\xD4\x05\x14\v\x02\xD4\xD5\x07\b\x02" +
		"\x02\xD5\xD6\x07\x03\x02\x02\xD6\xDF\x03\x02\x02\x02\xD7\xD8\x05\x14\v" +
		"\x02\xD8\xD9\x07\x03\x02\x02\xD9\xDF\x03\x02\x02\x02\xDA\xDB\x07\x1D\x02" +
		"\x02\xDB\xDF\x07\x03\x02\x02\xDC\xDD\x07\x1E\x02\x02\xDD\xDF\x07\x03\x02" +
		"\x02\xDE\xA6\x03\x02\x02\x02\xDE\xAC\x03\x02\x02\x02\xDE\xB4\x03\x02\x02" +
		"\x02\xDE\xBA\x03\x02\x02\x02\xDE\xC4\x03\x02\x02\x02\xDE\xCA\x03\x02\x02" +
		"\x02\xDE\xCD\x03\x02\x02\x02\xDE\xD1\x03\x02\x02\x02\xDE\xD7\x03\x02\x02" +
		"\x02\xDE\xDA\x03\x02\x02\x02\xDE\xDC\x03\x02\x02\x02\xDF\x17\x03\x02\x02" +
		"\x02\xE0\xE3\x05\x1A\x0E\x02\xE1\xE3\x03\x02\x02\x02\xE2\xE0\x03\x02\x02" +
		"\x02\xE2\xE1\x03\x02\x02\x02\xE3\x19\x03\x02\x02\x02\xE4\xEA\x05\x14\v" +
		"\x02\xE5\xE6\x05\x14\v\x02\xE6\xE7\x07\v\x02\x02\xE7\xE8\x05\x1A\x0E\x02" +
		"\xE8\xEA\x03\x02\x02\x02\xE9\xE4\x03\x02\x02\x02\xE9\xE5\x03\x02\x02\x02" +
		"\xEA\x1B\x03\x02\x02\x02\xEB\xEE\x05\x1E\x10\x02\xEC\xEE\x03\x02\x02\x02" +
		"\xED\xEB\x03\x02\x02\x02\xED\xEC\x03\x02\x02\x02\xEE\x1D\x03\x02\x02\x02" +
		"\xEF\xF5\x05\x14\v\x02\xF0\xF1\x05\x14\v\x02\xF1\xF2\x07\v\x02\x02\xF2" +
		"\xF3\x05\x1E\x10\x02\xF3\xF5\x03\x02\x02\x02\xF4\xEF\x03\x02\x02\x02\xF4" +
		"\xF0\x03\x02\x02\x02\xF5\x1F\x03\x02\x02\x02\xF6\xF7\t\x02\x02\x02\xF7" +
		"!\x03\x02\x02\x02\xF8\xF9\t\x03\x02\x02\xF9#\x03\x02\x02\x02\xFA\xFB\x07" +
		"+\x02\x02\xFB%\x03\x02\x02\x02\xFC\xFD\x05\x14\v\x02\xFD\'\x03\x02\x02" +
		"\x02\xFE\u0106\x070\x02\x02\xFF\u0100\x07\x07\x02\x02\u0100\u0101\x05" +
		"(\x15\x02\u0101\u0102\x07\b\x02\x02\u0102\u0106\x03\x02\x02\x02\u0103" +
		"\u0104\x07\x11\x02\x02\u0104\u0106\x05\x14\v\x02\u0105\xFE\x03\x02\x02" +
		"\x02\u0105\xFF\x03\x02\x02\x02\u0105\u0103\x03\x02\x02\x02\u0106)\x03" +
		"\x02\x02\x02\x108OSZe\x97\xA1\xA3\xDE\xE2\xE9\xED\xF4\u0105";
