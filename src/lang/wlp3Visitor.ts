...
export interface wlp3Visitor<Result> extends ParseTreeVisitor<Result> {
	/**
	 * Visit a parse tree produced by the `SingleArrElem`
	 * labeled alternative in `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitSingleArrElem?: (ctx: SingleArrElemContext) => Result;

	/**
	 * Visit a parse tree produced by the `MultiArrElems`
	 * labeled alternative in `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitMultiArrElems?: (ctx: MultiArrElemsContext) => Result;
	...
	/**
	 * Visit a parse tree produced by the `ArrInitElems`
	 * labeled alternative in `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitArrInitElems?: (ctx: ArrInitElemsContext) => Result;

	/**
	 * Visit a parse tree produced by the `ArrInitEmpty`
	 * labeled alternative in `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitArrInitEmpty?: (ctx: ArrInitEmptyContext) => Result;
	...
	/**
	 * Visit a parse tree produced by the `DclArrAssignment`
	 * labeled alternative in `wlp3Parser.expr`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitDclArrAssignment?: (ctx: DclArrAssignmentContext) => Result;

	/**
	 * Visit a parse tree produced by the `ArrIndex`
	 * labeled alternative in `wlp3Parser.expr`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitArrIndex?: (ctx: ArrIndexContext) => Result;
	...
	/**
	 * Visit a parse tree produced by `wlp3Parser.arrinit`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitArrinit?: (ctx: ArrinitContext) => Result;

	/**
	 * Visit a parse tree produced by `wlp3Parser.arrinitelems`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitArrinitelems?: (ctx: ArrinitelemsContext) => Result;
